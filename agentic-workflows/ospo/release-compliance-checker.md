...
description: >
  Analyzes a target repository against open source release requirements and
  posts a detailed compliance report as an issue comment. Checks for required
  files, security settings, license compliance, and generates a risk assessment.
