...
// success. A permanent "unsupported filter" (400) is a legitimately empty bucket
// — return empty without retrying. On a persistent transport failure, log and
// record a warning (via `warnings`) so the incompleteness isn't swallowed.
