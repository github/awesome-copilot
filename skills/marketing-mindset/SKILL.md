...
description: 'Use this skill when the user needs a professional marketer operating mindset for any marketing, growth, or client-acquisition task: finding first customers, writing an ad or landing page, designing ad creatives and visuals, evaluating an idea, deciding whether doing X will produce Y, positioning or launching a B2B or SaaS product, running cold outreach, or writing copy. Not a tactical template library.'
license: MIT
compatibility: 'Cross-platform. Pure reasoning skill over the user-provided business context, product, offer, and channel data. No external tools, network calls, or API keys.'
metadata:
  version: "1.0"
  author: Axel Freeman
