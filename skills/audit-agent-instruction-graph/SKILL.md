...
2. **Run the deterministic audit when authorized.** In a repository with Node.js 20 or newer, run the pinned, read-only Instructree release:
   ...
   ```bash
   npm exec --yes --package=github:kotobuki09/instructree#22c433db5dbd303fa26b6b59c81c6ab607e5a890 -- instructree
   npm exec --yes --package=github:kotobuki09/instructree#22c433db5dbd303fa26b6b59c81c6ab607e5a890 -- instructree imports
   ```
...
3. **Explain a concrete target.** If the problem concerns a file or directory, show the broad-to-specific candidates and transitive imports:
   ...
   ```bash
   npm exec --yes --package=github:kotobuki09/instructree#22c433db5dbd303fa26b6b59c81c6ab607e5a890 -- instructree explain path/to/target --effective
   ```
