...
- **Overview** — install, auth, output formats, patterns: [references/cli.md](references/cli.md)
...
- **Overview** — install, Config, auth, HttpClient: [references/python-sdk.md](references/python-sdk.md)
- **QuoteContext** — all quote methods + subscriptions: [references/python-sdk.md](references/python-sdk.md)
- **TradeContext** — orders, account, executions: [references/python-sdk.md](references/python-sdk.md)
- **Types & Enums** — Period, OrderType, SubType, push types: [references/python-sdk.md](references/python-sdk.md)

### Rust SDK

- **Overview** — Cargo.toml, Config, auth, error handling: [references/rust-sdk.md](references/rust-sdk.md)
- **QuoteContext** — all methods, SubFlags, PushEvent: [references/rust-sdk.md](references/rust-sdk.md)
- **TradeContext** — orders, SubmitOrderOptions builder, account: [references/rust-sdk.md](references/rust-sdk.md)
- **Content** — news, filings, topics (ContentContext + Python fallback): [references/rust-sdk.md](references/rust-sdk.md)
- **Types & Enums** — all Rust enums and structs: [references/rust-sdk.md](references/rust-sdk.md)
