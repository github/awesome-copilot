...
Use this skill whenever you verify code artifacts that migrated from Oracle, build the companion integration tests, or gate an agent workflow that depends on database changes. It codifies the expectations for validation, testing, and documentation for the `dbmigration` workload.
