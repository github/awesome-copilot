...
| [Java Development](collections/java-development.md) | Comprehensive collection of prompts and instructions for Java development including Spring Boot, Quarkus, testing, documentation, and best practices. | 11 items | java, springboot, quarkus, jpa, junit, javadoc |
