...
> **Note:** 4.1.1 Parsing was removed in WCAG 2.2 as obsolete. Issues it covered are now addressed by 1.3.1 and 4.1.2.
...
- **Severity**: CRITICAL
- **Detection**: `tabindex="[1-9]|tabIndex=\{[1-9]`
- **WCAG**: 2.4.3 (A)
