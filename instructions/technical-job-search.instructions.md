---
applyTo: "**"
description: "Instructions for using GitHub Copilot in technical job search workflows: parsing job descriptions, tailoring CVs, writing cover letters, and evaluating offers."
---

# Technical Job Search

Instructions for GitHub Copilot when helping software engineers with job search tasks: job description analysis, CV tailoring, cover letter writing, and offer evaluation.
