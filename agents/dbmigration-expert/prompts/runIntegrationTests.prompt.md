...
dotnet test "{TestProjectPath}" --logger "trx;LogFileName=TestResults.trx" --results-directory "{SOLUTION_ROOT}/.github/dbmigration/Reports/TestResults"
...
| Artifact | Location |
|----------|----------|
| TRX results file | `{SOLUTION_ROOT}/.github/dbmigration/Reports/TestResults/{Timestamp}_{Database}_TestResults.trx` |
