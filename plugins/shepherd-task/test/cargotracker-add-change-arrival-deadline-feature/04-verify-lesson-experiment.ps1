...
Write-Host "Inspect stage-30 session artifacts and PR changes for post-first issues: $($issueNumbers[1..($issueNumbers.Count - 1)] -join ',')."
Write-Host 'Look for evidence that prior validated lessons were actually read and applied.'
