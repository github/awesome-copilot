...
echo ""
echo "Stage-00 initialization scripts available at:"
echo "  $plugin_dest/scripts/shepherd-task-00-init-campaign.sh"
echo "  $plugin_dest/scripts/shepherd-task-00-init-campaign.ps1"
echo ""
echo "Stage-15 preparation scripts available at:"
echo "  $plugin_dest/scripts/shepherd-task-15-prepare-create-issues.sh"
echo "  $plugin_dest/scripts/shepherd-task-15-prepare-create-issues.ps1"
echo ""
echo "Stage-25 dispatch scripts available at:"
echo "  $plugin_dest/scripts/shepherd-task-25-given-list.sh"
echo "  $plugin_dest/scripts/shepherd-task-25-given-list.ps1"
echo ""
