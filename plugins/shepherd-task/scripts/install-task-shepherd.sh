...
echo ""
echo "Stage-20 preparation scripts available at:"
echo "  $plugin_dest/scripts/shepherd-task-prepare-create-issues.sh"
echo "  $plugin_dest/scripts/shepherd-task-prepare-create-issues.ps1"
echo ""
