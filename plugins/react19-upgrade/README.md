...
4. **react19-migrator**  Source code migration engine that systematically rewrites deprecated patterns:
...
2. **react19-source-patterns**  Migration patterns for source API changes and the `use()` hook for resource management.
