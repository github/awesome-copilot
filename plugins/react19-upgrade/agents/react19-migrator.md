...
### M5  forwardRef → ref as direct prop
...
- Remove `forwardRef` wrapper and import
- Move `ref` from 2nd arg into props destructure
- If `useImperativeHandle` is used  keep it, it works with direct ref props
...
echo "forwardRef remaining (should be 0)"
