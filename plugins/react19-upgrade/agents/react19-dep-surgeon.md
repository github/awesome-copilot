...
npm install @apollo/client@latest 2>/dev/null && echo "upgraded" || echo "not used"
```
...
npm install @emotion/react@latest @emotion/styled@latest 2>/dev/null && echo "upgraded" || echo "not used"
```
