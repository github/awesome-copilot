...
- Check the ADR directory for existing ADRs (common paths: `/docs/adr/`, `/docs/ADR/`, `/decisions/`)
...
- Save the file to the project's ADR directory with proper naming convention
...
9. **Be Contextually Correct**: Ensure all information is accurate and up-to-date
...
1. ADR file is created in the project ADR directory with correct naming
