...
function buildMergedIntakeComment(baseResult, qualityResult, runId, owner, repo) {
  ...
  return [
    ...
    baseResult.plugin?.source?.ref ? `- **Ref:** [\`${baseResult.plugin.source.ref}\`](https://github.com/${baseResult.plugin.repository}/tree/${baseResult.plugin.source.ref})` : undefined,
    baseResult.plugin?.source?.sha ? `- **SHA:** [\`${baseResult.plugin.source.sha}\`](https://github.com/${baseResult.plugin.repository}/tree/${baseResult.plugin.source.sha})` : undefined,
    "",
    qualitySection,
    "",
    "",
