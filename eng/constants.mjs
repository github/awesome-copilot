...
- Install a skill using the GitHub CLI: \`gh skills install ENEL-GICT-PTG/awesome-copilot <skill-name>\` (requires [GitHub CLI v2.90.0+](https://github.blog/changelog/2026-04-16-manage-agent-skills-with-github-cli/))
...
const repoBaseUrl =
  "https://raw.githubusercontent.com/ENEL-GICT-PTG/awesome-copilot/main";
