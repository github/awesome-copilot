import { LoadTools } from '../../src/tools/load';
...
describe('LoadTools', () => {
  ...
  let loadTools: LoadTools;

  const mockAgentItem: ContentItem = {
  ...
  const mockPromptItem: ContentItem = {
  ...
  const mockInstructionItem: ContentItem = {
  ...
  beforeEach(() => {
    ...
    loadTools = new LoadTools(mockAdapter);
    jest.clearAllMocks();
  });
