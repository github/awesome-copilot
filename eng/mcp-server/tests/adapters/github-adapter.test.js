...
describe('GitHubAdapter', () => {
    let adapter;
    beforeEach(() => {
        adapter = new github_adapter_1.GitHubAdapter();
        jest.clearAllMocks();
    });
    describe('fetchGitHubAPI', () => {
        it('should fetch data successfully', async () => {
            ...
            const result = await adapter.fetchGitHubAPI('/test');
        ...
        it('should throw error on API failure', async () => {
            ...
            await expect(adapter.fetchGitHubAPI('/test')).rejects.toThrow('GitHub API error: 404 Not Found');
        });
    });
    describe('getTree', () => {
    ...
    describe('getRawFile', () => {
        ...
        it('should throw error on fetch failure', async () => {
            ...
            await expect(adapter.getRawFile('nonexistent.md')).rejects.toThrow('Failed to fetch raw file: 404 Not Found');
        });
    });
...
Content`;
            ...
            expect(result.map((item) => item.type)).toEqual(['agent', 'prompt', 'instruction']);
        });
