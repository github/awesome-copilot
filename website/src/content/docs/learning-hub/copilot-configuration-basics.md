...
> **Model picker cleanup (v1.0.83+)**: Retired Claude and Gemini models are no longer shown in `/model` picker results, keeping the list focused on models that are still supported.
